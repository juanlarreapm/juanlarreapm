      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-16">
          <div>
            ...
            <p className="text-muted-foreground max-w-xl">
              Deep dives into impactful products I've built and shipped
            </p>
          </div>
        ...
        {isLoading ? (
              ...
              >
                <article className="h-full p-6 rounded-xl bg-card border border-border card-hover overflow-hidden relative">
                  ...
                  <ul className="space-y-2 mb-6">
                    {caseStudy.metrics?.slice(0, 2).map((metric: string) => (
          ...
          <div className="text-center py-16 rounded-xl bg-card border border-border">
            <p className="text-muted-foreground">No featured case studies yet.</p>
          </div>
        )}
      </div>
    </section>
